    ...
    <form id="employee_form" method="post" action="/realAuth_audit">
        ...
        <table>
            ...
            <tr>
                <td>账户名:</td>
                <td>
                    <label type="text" name="accountName" id="accountName"/>
                </td>
            </tr>
            <tr>
                <td>申请时间:</td>
                <td>
                    <label type="text" name="applyTime" id="applyTime"></label>
                </td>
            </tr>
            ...
            <tr>
                <td>开户行:</td>
                <td>
                    <label type="text" name="bankName" id="bankName"></label>
                </td>
            </tr>
            <tr>
                <td>账号:</td>
                <td>
                    <label type="text" name="accountNumber" id="accountNumber"/>
                </td>
            </tr>
            <tr>
                <td>开户支行:</td>
                <td>
                    <label type="text" name="forkName" id="forkName"></label>
                </td>
            </tr>
            <tr>
                <td>提现金额:</td>
                <td>
                    <label type="text" name="amount" id="amount"></label>
                </td>
            </tr>
...
<script>
    ...
    var cmdObj = {
        toEdit: function () {
            ...
            $("#accountName").html(rowData.accountName);
            $("#applyTime").html(rowData.applyTime);
            $("#forkName").html(rowData.forkName);
            $("#accountNumber").html(rowData.accountNumber);
            $("#bankName").html(rowData.bankName);
